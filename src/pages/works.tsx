        ...
        <SimpleGrid columns={[1, 1, 2]} gap={6}>
          <Section>
            <WorkGridItem id='inkdrop' title='Inkdrop' thumbnail={thumbInkdrop}>
              ...
              quisquam ad autem nisi quasi quas, obcaecati porro quam explicabo minima sunt accusamus!
            </WorkGridItem>
          </Section>
          <Section>
            <WorkGridItem id='walknote' title='Walknote' thumbnail={thumbWalknote}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos assumenda sequi earum itaque, unde iste debitis blanditiis architecto,
              sunt animi quisquam soluta, eius eaque aliquid explicabo ipsa rerum velit voluptates.
            </WorkGridItem>
          </Section>
        </SimpleGrid>
      </Container>
